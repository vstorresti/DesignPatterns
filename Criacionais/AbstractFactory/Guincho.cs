...
namespace AbstractFactory
{
    ...
    public class GuinchoPequeno : Guincho
    {
        ...
        {
            System.Console.WriteLine("Socorrendo Carro Pequeno - Modelo " + veiculo.Modelo);
        }
    }
    ...
    public class GuinchoMedio : Guincho
    {
        ...
        public override void Socorrer(Veiculo veiculo)
        {
            System.Console.WriteLine("Socorrendo Carro Medio - Modelo " + veiculo.Modelo);
        }
    }
    ...
    public class GuinchoGrande : Guincho
    {
        ...
        public override void Socorrer(Veiculo veiculo)
        {
            System.Console.WriteLine("Socorrendo Carro Grande - Modelo " + veiculo.Modelo);
        }
    }
